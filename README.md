...
The application presents a primary view of the scene with a fixed camera angle. The viewport design will be revised later.
...
- **Drag** any control point (blue sphere) in the main view — the full-body IK solver poses the rest of the body to compensate.
